...
<body id="page-top">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Andbayu 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">PIlih tombol "Logout" dibawah untuk keluar</div>
  ...
  @yield('script')
  <script>
      var waktu = setInterval(waktuNw,1000);
      function waktuNw() {
        var d = new Date();
        document.getElementById("waktu").innerHTML = d.toLocaleDateString();
      }
  </script>
</body>
